...
require 'enviaEmailReserva.php'; // Inclua a função de envio de e-mail
...
// Buscar reservas
$sql = "SELECT r.data, r.hora_inicio, r.hora_fim, l.nome AS laboratorio_nome, p.nome AS usuario_nome
        FROM reserva r
